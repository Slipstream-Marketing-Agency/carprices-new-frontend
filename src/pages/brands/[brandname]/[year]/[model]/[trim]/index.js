                ...
                <div className="single-item mb-50" id="car-milage">
                  <div className="car-milage">
                    ...
                    <div className="overview-content">
                      <ul>
                        <li>
                          <span>Petrol (Manual)</span> 24.0 kmpl
                        </li>
                        <li>
                          <span>Petrol (Automatic)</span> 22.0 kmpl
                        </li>
                      </ul>
                      <ul>
                        <li>
                          <span>Diesel (Manual)</span> 25.0 kmpl
                        </li>
                        <li>
                          <span>CNG (Manual)</span> 20 km/kg
                        </li>
                      </ul>
                    </div>
                  </div>

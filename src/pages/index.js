    ...
    <main className="flex flex-col items-center justify-between w-full font-gilroy ">
      ...
      Carpricces - a car research platform
            ...
            <p className="mt-5 text-lg leading-6">
              ...
              Explore innovation as you navigate the world of automotive pricing
      ...
      <div className="flex flex-col container">
        <div className="flex justify-between gap-5 px-px w-full max-md:flex-wrap">
          <div className="px-5">
            ...
            <h2 className="text-2xl font-semibold"> Latest Automotive News</h2>
          </div>
          {/* <div className="self-start px-6 py-3 mt-2.5 text-base tracking-tight leading-4 text-center rounded-[119px] text-neutral-900">
            View More
          </div> */}
            ...
            <div className="flex flex-col grow px-8 py-10 w-full bg-sky-100 rounded-2xl max-md:px-5 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="flex flex-col mt-9 text-neutral-900">
                ...
                <div className="mt-1 text-sm leading-5">
                  Say goodbye to endless scrolling and irrelevant listings. Our
                  advanced search filters allow you to find your dream car with
                  precision. Narrow down your search by make, model, year, price
                  range, mileage, and more, ensuring that every result matches
              ...
              <div className="flex flex-col mt-6 text-neutral-900">
                ...
                <div className="mt-1 text-sm leading-5">
                  With our extensive database of new and used cars, you'll have
                  access to a wide range of vehicles from trusted dealerships
                  across the UAE. Whether you're in the market for a luxury
                  sedan, a rugged SUV, or a fuel-efficient hatchback, we've got
                  you covered.
                </div>
              </div>
                ...
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  ...
                  <div className="flex flex-col ml-5 w-[29%] max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col text-sm leading-5 text-white max-md:mt-10">
                      <div className="tracking-wide uppercase">Comparisons</div>
                      <div className="flex flex-col mt-6">
                        <Link
                          legacyBehavior
                  ...
                  <div className="flex flex-col ml-5 w-1/5 max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col text-sm leading-5 text-white max-md:mt-10">
                      <div className="tracking-wide uppercase">Legal Bits</div>
                      <div className="flex flex-col mt-6">

    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={story.webstory.metaDescription}
        />
        <style amp-custom="">
          {`
        .letterbox {
      ...
      <amp-story
        standalone=""
        title={story.webstory.mainTitle}
        publisher={story.webstory.author}
        publisher-logo-src="/assets/images/logo/cp_logo_stories.jpg"
        poster-portrait-src={
          process.env.NEXT_PUBLIC_S3_URL + story.webstory.slides[0].image1
        }
      >
            ...
            <div className="letterbox">
              <div className="first-logo pa">
                <amp-img
                  ...
                  height="96"
                  layout="responsive"
                  src="/assets/images/logo/cp_logo_stories.jpg"
                  alt={story.webstory.slides[0].title}
                ></amp-img>
              </div>
              <h1 className="h1text" animate-in="fly-in-bottom">
                {story.webstory.slides[0].title}
              </h1>
              <span className="author">
                {" "}
                {moment(story.webstory.publishedAt).format("MMMM Do YYYY")}
              </span>
            </div>
          </amp-story-grid-layer>
        </amp-story-page>
        ...
        {story.webstory.slides.slice(1, -1).map((item, index) => (
          <amp-story-page id="story">
            <amp-story-grid-layer template="fill">
              <amp-img
                src={process.env.NEXT_PUBLIC_S3_URL + item.image1}
                width="720"
                height="1280"
                layout="responsive"
                alt="Cover"
            ...
            <amp-story-grid-layer template="thirds" className="bg_grad">
              <div className="letterbox">
                <h2 className="h1text" animate-in="fly-in-bottom">
                  {item.title}
                </h2>
                <span className="author">
                  {moment(story.webstory.publishedAt).format("MMMM Do YYYY")}
        ...
        <amp-story-page id="summary">
          <amp-story-grid-layer template="fill">
            <amp-img
              ...
              src={
                ...
                story.webstory.slides[story.webstory.slides.length - 1].image1
              }
              id="stid-pg-bg"
              alt={
                story.webstory.slides[story.webstory.slides.length - 1].title
              }
            ></amp-img>
          </amp-story-grid-layer>
          ...
          <amp-story-page-outlink layout="nodisplay">
            <Link href={`${story.webstory.url}`} title={story.webstory.urlName}>
              {story.webstory.urlName}
            </Link>
...
export async function getServerSideProps({ req, res, params }) {
  ...
  try {
    ...
    let resStory = await axios.get(
      process.env.NEXT_PUBLIC_API_URL_OLD + "webstory/by-slug/" + slug
    );

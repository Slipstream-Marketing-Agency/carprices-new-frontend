    ...
    <MainLayout>
              ...
              >
                ...
                <div className="single-compare mb-50" id="car-color">
                  <div className="car-colors">
                    ...
                    <Swiper
                      {...carColorSlide}
                      className="swiper car-color-slider"
                    >
                      <div className="swiper-wrapper">
                        <SwiperSlide className="swiper-slide">
                          <div className="car-color-wrap">
                            <div className="car-img">
                              <Image
                                src="/assets/img/inner-page/color-car-01.png"
                                width={400}
                                height={70}
                                alt="car image"
                              />
                        ...
                        <SwiperSlide className="swiper-slide">
                          <div className="car-color-wrap">
                            <div className="car-img">
                              <Image
                                src="/assets/img/inner-page/color-car-02.png"
                                width={400}
                                height={70}
                                alt="car image"
                              />
                        ...
                        <SwiperSlide className="swiper-slide">
                          <div className="car-color-wrap">
                            <div className="car-img">
                              <Image
                                src="/assets/img/inner-page/color-car-03.png"
                                width={400}
                                height={70}
                                alt="car image"
                              />
                        ...
                        <SwiperSlide className="swiper-slide">
                          <div className="car-color-wrap">
                            <div className="car-img">
                              <Image
                                src="/assets/img/inner-page/color-car-04.png"
                                width={400}
                                height={70}
                                alt="car image"
                              />
                        ...
                        <form>
                          <div className="form-inner">
                            {/* <SelectComponent
                              ...
                              placeholder="car conditon select"
                            /> */}
                          </div>
                        </form>
                      </div>
      ...
      <div className="compare-car-section mb-100">
        <div className="container-xl container-fluid">
          ...
          <div
            className="modal compare-modal fade"
            id="compareModal01"
            tabIndex={-1}
            aria-labelledby="compareModal01Label"
            aria-hidden="true"
          >
            <div className="modal-dialog modal-lg modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title" id="compareModal01Label">
                    Comparision
                  </h5>
                  <button
                    type="button"
                      ...
                      <div className="compare-top">
                        <div className="single-car">
                          <div className="car-img  position-relative">
                            <Image
                              src="/assets/img/home1/compare-md-01.png"
                              alt="car"
                              fill
                              objectFit="contain"
                            />
                          ...
                          <div className="content text-center">
                            <h6 className="title">
                              <a href="#">Mercedes-Benz C-Class-2023</a>
                            </h6>
                        ...
                        <div className="single-car">
                          <div className="car-img">
                            <Image
                              src="/assets/img/home1/compare-md-02.png"
                              fill="true"
                              objectFit="contain"
                              alt="car"
                            />
                          ...
                          <div className="content text-center">
                            <h6 className="title">
                              <a href="#">Jeep Grand Cherokee-2023</a>
                            </h6>
                        ...
                        <div className="table-wrapper">
                          <table className="eg-table">
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <strong>Engine Speed:</strong> 34,563 cc
                                </td>
                                <td>
                                  <strong>Engine Speed:</strong> 35,533 cc
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <strong>Body Type:</strong> Convertible
                                </td>
                                <td>
                              ...
                              <tr>
                                <td>
                                  <strong>Max. Power:</strong> 140 kw 7000 rpm
                                </td>
                                <td>
                                  <strong>Max. Power:</strong> 142 kw 7000 rpm
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <strong>Steering:</strong> Right
                                </td>
                                <td>
                                  <strong>Steering:</strong> Left
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <strong>Engine Type:</strong> 1.5 L Gas Engine
                                </td>
                                <td>
                                  <strong>Engine Type:</strong> 1.55 L Petrol
                                  Engine
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <strong>No Of Cylinders:</strong> 04
                                </td>
                                <td>
                                  <strong>No Of Cylinders:</strong> 04
                                </td>
                              ...
                              <tr>
                                <td>
                                  <Link legacyBehavior href="/car-deatils">
                                    <a className="primary-btn2">View Details</a>
                                  </Link>
                                </td>
                                <td>
                                  <Link legacyBehavior href="/car-deatils">
          ...
          <div className="row mb-40 wow fadeInUp" data-wow-delay="300ms"></div>
          <div className="row ">

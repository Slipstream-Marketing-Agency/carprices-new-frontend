  ...
  if (req.method === "POST") {
    ...
    try {
      ...
      await transporter.sendMail({
        ...
        to: "sahin@slipstream.agency,martin@slipstream.agency,abubacker@slipstream.agency,chaitali@slipstream.agency,ahmed@slipstream.agency", // Add the email(s) where you want to receive the notifications
        subject: "New Insurance Quote Enquiry",
        html: emailMessage,
      });

      // Send a success response
      res.status(200).json({ message: "Insurance quote submitted successfully, and email sent." });
...
export default rateLimit(handler, 15 * 60 * 1000); // Adjust the rate limit as needed

          ...
          <div className="car_description">
            ...
            {isRtl ? (
              ...
              <p>
                ...
                <b>{allTrims?.length}</b> variants: {variableText}.
              </p>
            )}
            ...
            {mainTrimFuelType === "Electric" ? (
              motorTypeCount?.length <= 1 || motorTypeCountOr?.length <= 1 ? (
                <p>
                  <b></b> It comes with a <b>{motorTypes}</b>.
                </p>
              ) : (
                <p>
                  <b>Motor:</b> It is equipped with a <b>{motorTypes}</b> based
                  on the variant.
                </p>
              )
            ) : mainTrimFuelType === "Hybrid" ? (
            ...
            (mainTrimFuelType === "Hybrid" &&
              ...
              minRange === maxRange ? (
                <p>
                  <b>{t.range}: </b>The claimed range is <b>{minRange}km</b> on
                  a single charge.
                </p>
              ) : (
                <p>
            ...
            (mainTrimFuelType === "Hybrid" && batteryCapacity !== "") ? (
              allTrims.length <= 1 ? (
                ...
                <p>
                  <b>{t.batteryCapacity}: </b>It comes with a{" "}
                  <b>{mainTrim.batteryCapacity}</b> battery based on the
                  variant.
                </p>
              )
            ) : (

    ...
    <div className="tw-bg-white tw-rounded-lg tw-overflow-hidden tw-shadow-lg hover:tw-shadow-2xl tw-transition-shadow tw-duration-300">
      <Link href={release.attributes.url}>
        <img
          ...
          className="tw-w-full tw-h-48 lg:tw-h-64 tw-object-cover"
        />
      </Link>
      <div className="tw-p-4">
        <div className="tw-flex tw-items-center tw-justify-between tw-mb-2">
          <p className="tw-text-sm tw-text-gray-500 tw-bg-gray-200 tw-rounded-full tw-px-2 tw-py-1">
            <span className="tw-font-semibold">Published:</span> {formattedDate}
          </p>
        </div>
        ...
        <p className="tw-text-gray-700 tw-mb-4 tw-line-clamp-3">
          {release.attributes.summary}
        </p>

        <div className="tw-flex tw-items-center tw-justify-between tw-mb-2">
          <p className="tw-text-sm tw-text-white tw-bg-black tw-rounded-full tw-px-2 tw-py-1">
            <span className="tw-font-semibold">Featured In:</span>{" "}
            {release.attributes.FeaturedIn}
          </p>
        </div>
        <div className="tw-flex tw-justify-between tw-items-center">
          ...
          <a
            href={downloadUrl}
            download
            className="tw-inline-block tw-py-2 tw-px-4 tw-bg-gray-200 tw-text-gray-700 tw-font-semibold tw-rounded-lg hover:tw-bg-gray-300 tw-transition-colors tw-duration-300"
          >
            Download Media
          </a>
        </div>

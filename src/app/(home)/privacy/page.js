...
// Use this function to dynamically generate metadata based on the path
        ...
        <div className="container mx-auto pt-10 pb-24 px-6 lg:px-20">
            ...
            <div className="space-y-10">
                ...
                <div className="bg-white shadow-lg rounded-lg p-8">
                    ...
                    <ul className="list-disc list-inside text-gray-700 ml-4">
                        <li className="my-2">Browsing behavior and preferences</li>
                    </ul>
                </div>
                ...
                <div className="bg-white shadow-lg rounded-lg p-8">
                    ...
                    <ul className="list-disc list-inside text-gray-700 ml-4">
                        <li className="my-2">Your consent</li>
                        <li className="my-2">
                            The necessity to perform a contract with you
                        </li>
                        <li className="my-2">Compliance with legal obligations</li>
                        <li className="my-2">
                ...
                <div className="bg-white shadow-lg rounded-lg p-8">
                    <h4 className=" font-semibold mb-4">Third-Party Websites</h4>
                    <p className="text-gray-700 leading-relaxed">
                ...
                <div className="bg-white shadow-lg rounded-lg p-8">
                    <h4 className=" font-semibold mb-4">Your Consent</h4>
                    <p className="text-gray-700 leading-relaxed">
                ...
                <div className="bg-white shadow-lg rounded-lg p-8">
                    <h4 className=" font-semibold mb-4">Contacting Us</h4>
                    <p className="text-gray-700 leading-relaxed">

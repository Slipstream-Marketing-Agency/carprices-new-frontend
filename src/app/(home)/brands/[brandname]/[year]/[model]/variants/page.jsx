...
export async function generateMetadata({ params }) {
    ...
    try {
        ...
        const pageTitle = `${year} ${currentmodel.brand?.name} ${currentmodel.name} Variants | Compare Features & Prices - Carprices.ae`;
        const pageDescription = `Compare all available variants of the ${year} ${currentmodel.brand?.name} ${currentmodel.name}. Find the best option based on features, price, and specifications in the UAE.`;
        ...
        return {
            ...
            openGraph: {
                title: pageTitle,
                description: pageDescription,
                url: `/brands/${brandname}/${year}/${model}/variants`,
            },
            twitter: {
    ...
    return (
        <div className='mt-6'>
            <ModelWrapper
                ...
                seoData={seoData}
                parentPage="variants&prices"
                activeTab="#variants&prices"
            />
        </div>
    );
}

...
export async function generateMetadata({ params }) {
    ...
    try {
        ...
        return {
            title: `${year} ${currentmodel.brand?.name} ${currentmodel.name} Reviews | Real Customer Feedback - Carprices.ae`,
            description: `Read real user reviews of the ${year} ${currentmodel.brand?.name} ${currentmodel.name}. Discover customer experiences, opinions on performance, and insights to help you choose your next car on Carprices.ae.`,

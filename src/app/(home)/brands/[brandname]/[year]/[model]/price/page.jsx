...
export async function generateMetadata({ params }) {
    ...
    try {
        ...
        const pageTitle = seoData?.metaTitle || `${year} ${currentmodel.brand?.name} ${currentmodel.name} Price in UAE | Specs, Features & Offers - Carprices.ae`;
        const pageDescription = `Discover the latest ${year} ${currentmodel.brand?.name} ${currentmodel.name} price in the UAE. Explore detailed specifications, features, and images from trusted dealers. Compare models and find exclusive deals on Carprices.ae.`;
        ...
        return {
            ...
            openGraph: {
                title: pageTitle,
                description: pageDescription,
                url: `/brands/${brandname}/${year}/${model}/price`,
            },
            twitter: {

...
export async function generateMetadata({ params }) {
    ...
    try {
        ...
        const pageTitle = `${year} ${currentmodel.brand?.name} ${currentmodel.name} FAQs | Common Questions Answered - Carprices.ae`;
        const pageDescription = `Get answers to frequently asked questions about the ${year} ${currentmodel.brand?.name} ${currentmodel.name}. Explore details on price, features, specs, and availability in the UAE on Carprices.ae.`;
        ...
        return {
            ...
            openGraph: {
                title: pageTitle,
                description: pageDescription,
                url: `/brands/${brandname}/${year}/${model}/faq`,
            },
            twitter: {

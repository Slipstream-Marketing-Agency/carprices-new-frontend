...
export async function generateMetadata({ params }) {
    ...
    try {
        ...
        return {
            title: `${year} ${currentmodel.brand?.name} ${currentmodel.name} Specifications | Engine, Dimensions & Features - Carprices.ae`,
            description: `Explore the full specifications of the ${year} ${currentmodel.brand?.name} ${currentmodel.name}. Learn about engine performance, dimensions, safety features, and more for the UAE market.`,

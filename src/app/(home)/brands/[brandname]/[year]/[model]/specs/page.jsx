...
export async function generateMetadata({ params }) {
    ...
    try {
        ...
        const pageTitle = `${year} ${currentmodel.brand?.name} ${currentmodel.name} Specifications | Engine, Dimensions & Features - Carprices.ae`;
        const pageDescription = `Explore the full specifications of the ${year} ${currentmodel.brand?.name} ${currentmodel.name}. Learn about engine performance, dimensions, safety features, and more for the UAE market.`;
        ...
        return {
            ...
            openGraph: {
                title: pageTitle,
                description: pageDescription,
                url: `/brands/${brandname}/${year}/${model}/specs`,
            },
            twitter: {

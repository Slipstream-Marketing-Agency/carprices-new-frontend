        ...
        <div className="flex flex-col lg:flex-row gap-5 justify-between">
          ...
          <div className="bg-white border-4 border-black p-8 rounded-3xl shadow-md w-full lg:w-1/3">
           <a  href="https://avatruae.com/" > <h2 className="text-lg lg:text-2xl font-semibold">AVATR Offer</h2> </a>
            ...
            <a href="https://avatruae.com/?utm_source=link&utm_medium=cp&utm_campaign=traffic-backlink" className="mt-{20px}">
                <button
                  type="button"
                  className="bg-black text-white py-3 rounded-md font-semibold hover:bg-gray-800 transition cursor-pointer"
                >
                 Explore Avatr
                </button>
              </a>

...
export default function FixedAd728x90({ dataAdSlot }) {
  ...
  const adHiddenKey = 'adHiddenUntil';
  ...
  return (
    <div className="hidden md:fixed bottom-0 left-0 w-full z-50 py-2 md:flex justify-center items-center">
      <div className="Ad728x90 relative">

  ...
  return (
    <div className="tw-mt-12 tw-w-full max-md:tw-pr-5 max-md:tw-mt-10 max-md:tw-max-w-full tw-container">
      ...
      <div className="tw-flex tw-gap-5 max-md:tw-flex-col max-md:tw-gap-0">
        <div className="tw-flex tw-flex-col tw-w-[50%] max-md:tw-ml-0 max-md:tw-w-full">
        ...
        <div className="tw-flex tw-flex-col tw-ml-5 tw-w-[50%] max-md:tw-ml-0 max-md:tw-w-full">

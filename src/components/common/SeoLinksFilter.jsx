  ...
  return (
    <div className="container w-full sm:mt-12 max-md:pr-5 max-md:mt-10">
      <div className="flex flex-col self-start mb-6 sm:mb-8 md:max-w-full">
        <h5 className="text-xs tracking-wide leading-5 text-blue-600 uppercase font-bold">
          Frequently Searched
        </h5>
        <h2 className="font-semibold sm:text-xl">What Others Are Searching For?</h2>
      </div>
      <div className="sm:grid sm:grid-cols-2 gap-6 space-y-6 sm:space-y-0">
        ...
        <div className="col-span-1">
          <div className="font-bold leading-6 capitalize sm:text-xl">

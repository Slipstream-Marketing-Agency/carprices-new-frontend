...
export default function MoreBrands() {
    ...
    return (
        <div className="boxShadows p-2 px-3">

            <div className=''>
                <h5 className='mb-4 mt-2'>{t.otherBrands}</h5>
                <div className="row">
                ...
                <div className='my-2 mx-2'><a href='/brands' ><span className='viewAllbrandTxt'>{t.viewbrand}</span></a></div>
            </div>
        </div>
    )
}

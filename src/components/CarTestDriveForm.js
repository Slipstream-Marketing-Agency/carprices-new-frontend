          ...
          <Form onSubmit={handleSubmit}>
            <DialogContent dividers>
              <Typography variant="body1" mb={2}>
                ...
                <strong>{fullCarName}</strong>. We will forward your request to
                the authorised dealer and their team will contact you at the
                earliest to schedule a test drive.
              </Typography>
              <TextField
                fullWidth
                margin="normal"

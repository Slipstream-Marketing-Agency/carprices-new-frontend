...
export default function BlogRelated({blogs,heading,disableMarginTop,disableBorder,disableHeading}) {
                            ...
                            <div className='fs-6 blog_wrapper mb-2 p-2'>
                                <div className='d-flex align-items-center gap-2'>
                                    ...
                                    <div className={` me-4 ms-4 `} >
                                        <span className="text-bold blogFont me-4">{`${blog?.attributes?.articles?.data[0]?.attributes?.title?.length > 40 ? `${blog?.attributes?.articles?.data[0]?.attributes?.title?.slice(0, 63)} ...` : `${blog?.attributes?.articles?.data[0]?.attributes?.title}`}`}</span>
                                    </div>
                                </div>
                            </div>
                        </Link>

...
export default function StepThree({ filterData, setFilterData, seatList }) {
  ...
  const initialFilterItems = [
    ...
    { label: `5-7 ${t.seats}`, value: ["6 Seater", "7 Seater"], group: "6-7", img: "/assets/img/homepage-filter-icons/Seats-5-7.png" },
    { label: `7-9 ${t.seats}`, value: [ "8 Seater", "9 Seater"], group: "8-9", img: "/assets/img/homepage-filter-icons/Seats-7-9.png" },
  ];

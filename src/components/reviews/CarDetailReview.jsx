...
const CarDetailReview = ({ name, brand, model, year, fromReviewPage = false, link = '#' }) => {
    ...
    const ReadMoreText = ({ text }) => {
        ...
        const MAX_LENGTH = fromReviewPage ? 250 : 100;
    ...
    // Get rating label based on averageRating, but don't show "Poor" if no reviews
    const getRatingLabel = (rating, reviewCount) => {
        if (reviewCount === 0) return ''; // No label if there are no reviews
        ...
        <div className="w-full bg-white shadow-lg rounded-lg mb-8" id='user-reviews'>
            ...
            <div className='p-6'>
                ...
                <div className="flex items-center space-x-4 mb-6">
                    <div className="flex items-center text-gray-800 text-4xl font-bold">
                        <StarIcon sx={{ color: '#f79712' }} className='h-10 w-10' />
                        {averageRating ? averageRating.toFixed(1) : '0.0'}/5
                    </div>
                    <div>
                        <p className="text-gray-700 font-semibold">{getRatingLabel(averageRating, reviews.length)}</p>
            ...
            <div className="p-6">
                ...
                {reviews.length > 0 ? (
                    ...
                    <p className="text-center text-gray-500">No reviews yet. Be the first to review this car!</p>
                )}

...
export default function BannerSection({ setShowModal }) {
  return (
    <div className="tw-bg-gradient-to-tl tw-to-[#275BA7] tw-via-[#275BA7] tw-from-[#77cdf2]  tw-rounded-2xl md:tw-p-10 tw-p-8 tw-text-white tw-flex tw-relative tw-overflow-hidden tw-custom-gradient">
      <div>
        <div className="tw-text-4xl md:tw-w-[90%] tw-capitalize">
          Choose the car to calculate loan EMI
        </div>
        <div className=" tw-mb-6 md:tw-w-[90%] tw-opacity-80 tw-mt-3">

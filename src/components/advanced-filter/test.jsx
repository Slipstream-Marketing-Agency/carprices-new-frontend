              ...
              <div className="product-widget mb-8">
                <div className="check-box-item">
                  ...
                  >
                    ...
                    <ul className="overflow-list pt-4 pb-4">
                      {filteredAndSortedBrandOptions.map((item, idx) => (
                        <li key={idx}>
                          <label className="containerss">
                            <input
            ...
            <div key={filter.id}>
              ...
              >
                <div className="modal-content">
                  <div className="modal-header py-3 bg-gray-300">
                    <h2 className="modal-title font-bold text-black">
                      {filter.label}
                    </h2>
                    <Button
                      onClick={() => handleToggleModal(filter.id)}
      ...
      <div className={`d-md-block d-none order-xl-1 order-2 `}>
        ...
        >
          ...
          <div className="product-widget mb-3">
            <div className="check-box-item">
              <h1
                className="product-widget-title !text-[1.2rem] cursor-pointer pb-3"
                onClick={togglePriceDropdown}
              >
                Price
                <span
          ...
          {router.pathname !== "/brands/[brandname]" && (
            <div className="product-widget mb-3">
              <div className="check-box-item">
                ...
                <div
                  className={`checkbox-container overflow-hidden mt-5 ${showBrandDropdown ? "show" : "hide"
                    }`}
                >
                  <div className="form-inner">
                    <input

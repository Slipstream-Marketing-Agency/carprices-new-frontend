...
export default function ModelDescription({
  ...
  return (
    <>
      <div className="mb-10">
        <h2 className="font-semibold mb-5">{brand?.name} {model?.name} {year} in UAE Specs</h2>
              ...
              <td className="py-4 px-6">
                {isRtl ? (
                  ...
                  <>
                    ...
                    <span className="capitalize">{variableText}</span>.
                  </>
                )}
              </td>
            </tr>
              ...
              <tr className="border-b border-gray-200">
                ...
                <td className="py-4 px-6">
                  ...
                  {features.map((feature, index) => (
                    <b key={feature} className="capitalize">

...
const SelectCar = ({ showModal, setShowModal, setCarDetails }) => {
    ...
    const handleYearSelection = (year) => {
        ...
        setCarDetails({ brand: selectedBrand, model: selectedModel, year: year });
        router.push({
            pathname: router.pathname,
            query: { brand: selectedBrand, model: selectedModel, year: year },
        });
    };

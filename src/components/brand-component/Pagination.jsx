...
export default function Pagination({ currentPage, pageCount, type, totalResults, pageSize, onPageChange, onPageSizeChange }) {
    const [selectedPageSize, setSelectedPageSize] = useState(pageSize);

    const handlePageSizeChange = (e) => {
        const newSize = parseInt(e.target.value, 10);
        setSelectedPageSize(newSize);
        onPageSizeChange(newSize); // Callback to update page size in parent component
    };

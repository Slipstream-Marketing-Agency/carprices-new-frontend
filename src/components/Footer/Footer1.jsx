          ...
          <div className="mt-2 row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-1 justify-content-center g-lg-4 gy-5 ">
            <div className="col d-flex justify-content-lg-start">
              <div className="footer-widget">
                ...
                <div className="menu-container">
                  <ul>
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/10-popular-cars-in-uae-with-high-ground-clearance-sorted-by-price-low-to-high-best-cars-in-uae">
                        <a>
                    ...
                    <li>
                      <Link legacyBehavior href=" https://carprices.ae/news/2023's-top-10-cars-that-buyers-searched-for-on-carprices.ae">
                        <a>
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/chinese-car-brands-uae ">
                        <a>
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/10-myths-busted-about-buying-a-new-car-in-the-uae">
                       <a>
                       10 Myths About Buying a New Car
                        <svg
                          width={10}
                          height={10}
                          viewBox="0 0 10 10"
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/top-fuel-effnt">
                        <a>
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/top-10-hybrid-cars-AED-230k">
                        <a>
                        10 Best Hybrid Cars
                        <svg
                          width={10}
            ...
            <div className="footer-widget">
                ...
                <div className="menu-container">
                  <ul>
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/the-2024-toyota-land-cruiser-prado-vs-the-gwm-tank-500">
                        <a>
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/2024-toyota-land-cruiser-prado-vs-land-rover-defender-vs-jeep-wrangler-vs-the-ford-bronco">
                        <a>
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/the-2023-toyota-land-cruiser-300-series-vs-the-2024-toyota-land-cruiser-prado">
                        <a>
                    ...
                    <li>
                      <Link legacyBehavior href="2024 LC Prado Vs Used LC Prado">
                       <a>
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/lc-prado-vs-patrol">
                        <a>
                        2024 LC Prado Vs Nissan Patro
                        <svg
                          width={10}
                          height={10}
                          viewBox="0 0 10 10"
            ...
            <div className="footer-widget">
                ...
                <div className="menu-container">
                  <ul>
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/internal-combustion-engine-car-vs-hybrid-car-which-will-be-worth-buying-in-the-uae">
                        <a>
                        ICE Vs Hybrid
                          <svg
                            width={10}
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/analysing-the-cost-of-living-with-the-electric-vehicle-vs-internal-combustion-engine-vehicle-in-the-uae-ev-vs-ice">
                        <a>
                        ICE Vs EV
                        <svg
                          width={10}
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/7-popular-reliable-sedans-to-buy-in-the-uae-in-2024-or-best-cars-in-uae">
                        <a>
                        Popuar Reliable Sedans
                        <svg
                          width={10}
                          height={10}
                          viewBox="0 0 10 10"
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/5-exciting-car-launches-to-happen-in-the-uae-in-2024">
                       <a>
                       2024 Car Launches
                        <svg
                          width={10}
                    ...
                    <li>
                      <Link legacyBehavior href="https://carprices.ae/news/6-best-chinese-suv-cars-in-uae-under-aed-70000">
                        <a>
                        Best Chinese SUVs
                        <svg
                          width={10}
        ...
        <div className="footer-center mt-5 ">
          <div className="footer-logo">
            <Link legacyBehavior href="/">
              <a>
              <img src="/assets/img/car-prices-logo.png" alt="logo" width={200} height={90}/>
              </a>
            </Link>
          </div>
          <div className="contact-area">
            <div className="hotline-area">
              ...
              <div className="content">
                ...
                <h6>
                  <a href="tel:+990737621432">+971 58 549 4351</a>
                </h6>
              </div>
            </div>
            <div className="hotline-area">
              ...
              <div className="content">
                ...
                <h6>
                  <a href="mailto:hello@slipstream.agency
">hello@slipstream.agency
</a>
                </h6>
              </div>
            </div>
          ...
          <div className="footer-btm">
            ...
            <div className="social-area">
              ...
              <ul>
                ...
                <li>
                  <a href="https://twitter.com/CarPrices_AE">
                    <i className="bx bxl-twitter" />
                  </a>
                </li>
                <li>
                  <a href="https://ae.linkedin.com/company/car-prices-ae?trk=similar-pages">
                    <i className="bx bxl-linkedin" />
                  </a>
                </li>
                <li>
                  <a href="https://www.instagram.com/carprices.ae/">

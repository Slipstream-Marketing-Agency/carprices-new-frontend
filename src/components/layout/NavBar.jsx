    ...
    const fetchData = async () => {
      try {
        const data = await axios.get(
          `${process.env.NEXT_PUBLIC_API_URL}home/find`
        );
    ...
    <>
      ...
      <div className="bg-white hidden md:block w-full border-solid border-b-[1px] border-gray-200 md:mb-28">
        <div className="w-full">
          ...
          <div
            className={`bg-white ${
              scrolledDown ? "translate-y-[-100%]" : "translate-y-0"
            } md:fixed z-20 w-full border-solid border-b-[1px] border-gray-200 transition-transform duration-300`}
          >
              ...
              >
                {user ? (
                  ...
                  >
                    ...
                    {hoveredMenuItem === "profile" && (
                      <HoveredProfile setHoveredMenuItem={setHoveredMenuItem} />
                    )}
                  </div>
                ) : (
                  <PrimaryButton
          ...
          <div
            className={`fixed flex justify-between min-h-14 shadow-md items-center left-0 w-full bg-white border-solid border-[1px] border-gray-200 z-10 transition-all duration-200 ${
              scrolledDown ? "top-0" : "top-16"
            }`}
          >
            {/* Logo Section */}
            <div className="flex items-center">
            ...
            <div className={`flex gap-5 ${scrolledDown ? "" : "mt-2"}`}>
              {links.map((link, i) => {
                ...
                const isHovered =
                  !!link.hoverItem && hoveredMenuItem === link.hoverItem;
                ...
                return (
                  <div
                    ...
                    onMouseOver={() => {
                      if (link.hoverItem) setHoveredMenuItem(link.hoverItem);
                    }}
                  ...
                  >
                    <Link
                      ...
                      className={[
                        "flex items-center p-1 justify-center font-normal text-sm border-t-2",
                        isHovered
                    ...
                    >
                      ...
                      {/* Show chevron only for links that have a dropdown */}
                      {link.hoverItem && (
                        <svg
                    ...
                    {/* Dropdown only when this specific item is hovered */}
                    {link.hoverItem && hoveredMenuItem === link.hoverItem && (
      ...
      <div className="gap-5 justify-between bg-white w-full md:hidden flex ">
        {searchClicked ? (
          ...
          <div className="gap-5 justify-between px-5 py-4 bg-white w-full md:hidden flex">
            ...
            <div
              className={`fixed top-0 left-0 z-10 w-full h-full bg-black bg-opacity-50 transition-opacity duration-300 ${

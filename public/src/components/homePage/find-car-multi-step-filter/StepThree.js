  ...
  const filterItems = [
    {
      label: "2 Seats",
      value: "2",
      img: "/assets/images/homepage-filter-icons/Seats-2.png",
    },
    {
      label: "2 + 2 Seats",
      value: "2+2",
      img: "/assets/images/homepage-filter-icons/Seats-2+2.png",
    },
    {
      label: "4-5 Seats",
      value: "4-5",
      img: "/assets/images/homepage-filter-icons/Seats-4-5.png",
    },
    {
      label: "5-7 Seats",
      value: "5-7",
      img: "/assets/images/homepage-filter-icons/Seats-5-7.png",
    },
    {
      label: "7-9 Seats",
      value: "7-9",
      img: "/assets/images/homepage-filter-icons/Seats-7-9.png",
    },
  ];
      ...
      <div className="search_filter_box_items" id="seats_filter">
        <div className="d-flex justify-content-center flex-wrap">
          {filterItems.map((item, index) => (
            <div
              key={index}
              className={` banner_btn ${filterData.seating.includes(item.value) ? "active" : ""
                }`}
              onClick={() => handleSeatingClick(item.value)}
            >
              {/* <i className={`bi bi-${item.icon}`} /> */}
              <Image width={100} height={100} src={item.img} alt={item.label}></Image>

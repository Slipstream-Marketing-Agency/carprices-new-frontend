      ...
      <div className="w-100 me-2 filtered_card_wrapper h-100">
        <div className="inner">
          ...
          <div className="filter_car_image">
            <Link href={`/brands/${specificVehicleFilter?.brand?.slug}/${specificVehicleFilter?.year}/${specificVehicleFilter?.model?.name?.toLowerCase().replace(/\s+/g, '-')}/${specificVehicleFilter?.slug}`}>

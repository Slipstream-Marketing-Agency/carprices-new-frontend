  ...
  const faq = [
    {
      ...
      answer: <>The {model.model.brand.name} {model.model.name} {model?.model?.minPrice === model?.model?.maxPrice && model?.model?.minPrice !== null && model?.model?.minPrice !== null ? <> is priced at AED <Price data={model?.model?.minPrice} /></> : ""}{model?.model?.minPrice !== model?.model?.maxPrice && model?.model?.minPrice !== null && model?.model?.minPrice !== null ? <>is priced within the range of AED <Price data={model?.model?.minPrice} /> - AED <Price data={model?.model?.maxPrice} /></> : ""}{model?.model?.minPrice === null && model?.model?.maxPrice === null ? <> is priced at AED <Price data={model?.model?.minPrice} /></> : ""}</>,
      id: 1,
      condition: true,
    },
    {
      ...
      answer: `The ${model?.model?.mainTrim?.year} ${model.model.brand.name} ${model.model.name} reaches 0 to 100km/h in ${model.model.mainTrim.zeroToHundred}seconds and has a top speed of ${model.model.mainTrim.topSpeed}km/h.`,
      id: 2,
      condition: true,
    },
    {
    ...
    },
    {
      ...
      answer: `The ${model?.model?.mainTrim?.year} ${model.model.brand.name} ${model.model.name} has a claimed fuel efficiency of ${model.model.mainTrim.fuelConsumption} kmpl${model.model.mainTrim.range ? " and a range of "+ model.model.mainTrim.range + " km" :""}.`,
      id: 11,
      condition:
        model?.model?.mainTrim?.fuelType === "Hybrid" ||
    ...
    },
    {
      ...
      answer: `The ${model?.model?.mainTrim?.year} ${model.model.brand.name} ${
        model.model.name
      } is equipped with a ${(model.model.mainTrim.displacement / 1000).toFixed(1) }L ${model.model.mainTrim.engine} engine and is paired with ${getTransmissionType()} transmission.`,
      id: 4,
      condition:
        model?.model?.mainTrim?.fuelType === "Hybrid" ||
        model?.model?.mainTrim?.fuelType === "Petrol" ||
    ...
    },
    {
      ...
      } ${model.model.name} include ${ model.model.mainTrim.airbags ?  model.model.mainTrim.airbags + " airbags, " :""}ABS, ${
        model.model.mainTrim.haveFrontParkAssist ?"front park assist, ":""
      }${model.model.mainTrim.haveRearParkAssist ? "rear park assist, ":""}${
        model.model.mainTrim.have360ParkingCamera ? "360° parking camera, ":""
      }${
    ...
    },
    {
      ...
      `,
      answer: `The ${model?.model?.mainTrim?.year} ${model.model.brand.name} ${model.model.name} has dimensions of ${model.model.mainTrim.length}mm length, ${model.model.mainTrim.width}mm width, and ${model.model.mainTrim.height}mm height.
      `,
      id: 7,
      condition: true,
    },

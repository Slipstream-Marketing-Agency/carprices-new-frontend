...
export default function TrimOverview({ trim }) {
  ...
  useEffect(() => {
    ...
    setCurrentImage(trim?.trim?.featuredImage !== "" ? trim?.trim?.featuredImage : trim?.trim?.images[0]?.image)
  }, [trim])
  ...
  const [price, setPrice] = useState(trim?.trim?.price ? trim?.trim?.price : "" );
            ...
            <div className="col-md-6">
              <div className="row">
                <div className="col-12">
                  <div className="row">
                    <div className="col-12">
                      <Galleria value={newImageArray} responsiveOptions={responsiveOptions} numVisible={5} item={itemTemplate} thumbnail={thumbnailTemplate} className="custom_galleria" />
                    </div>
              ...
              {trim?.trim?.price === null ? (
                ...
                <div className="calculator mt-2">
                  <div className="calculator-body">
                    ...
                    {monthlyRepaymentResult !== 0 && downPaymentResult !== 0 && totalCostResult !== 0 &&
                      <div>
                        <div className=" mt-1 ">
                          ...
                          <div className="white_bg_wrapper py-0 px-2 mt-1">
                            ...
                            <span className="fw-bold font_small" id="total-cost-result">

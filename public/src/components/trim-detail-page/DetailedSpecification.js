        ...
        <div className="row mt-2">
          <div className="col-sm-6 col-12">
            {trim?.trim?.fuelType === "Electric" ? (
              ...
              <div className="white_bg_wrapper mt-1">
                ...
                <div className="d-flex justify-content-between align-items-center mt-1">
                  <p>No. of Cylinders</p>
                  <p className="fw-bold">{trim?.trim?.cylinders ? trim?.trim?.cylinders : "-"}</p>
                </div>
                <div className="d-flex justify-content-between align-items-center mt-1">
                  <p>Displacement</p>
            ...
            <div className="white_bg_wrapper mt-2">
              ...
              <div className="d-flex justify-content-between align-items-center mt-1">
                <p>No. of Airbags</p>
                <p className="fw-bold"> {trim?.trim?.airbags ? trim?.trim?.airbags : "-"}</p>
              </div>
          ...
          <div className="col-sm-6 col-12 mt-sm-0 mt-2">
            {trim?.trim?.fuelType === "Electric" ? (
              ...
              <div className="white_bg_wrapper mt-1">
                ...
                <div className="d-flex justify-content-between align-items-center mt-1">
                  ...
                  <p className="fw-bold"> {trim?.trim?.fuelConsumption}kmpl</p>
                </div>
              </div>
            )}
            ...
            <div className="white_bg_wrapper mt-2">
              ...
              <div className="d-flex justify-content-between align-items-center mt-1">
                <p>Top Speed</p>
                <p className="fw-bold"> {trim?.trim?.topSpeed}kmph</p>
              </div>
            </div>
            ...
            <div className="white_bg_wrapper mt-2">
              ...
              <div className="d-flex justify-content-between align-items-center mt-1">
                ...
                <p className="fw-bold">
                  {" "}
                  {trim?.trim?.length ? trim?.trim?.length + "mm" : "-"}
                </p>
              </div>
              <div className="d-flex justify-content-between align-items-center mt-1">
                <p>Width</p>
                <p className="fw-bold">
                  {" "}
                  {trim?.trim?.width ? trim?.trim?.width + "mm" : "-"}
                </p>
              </div>
              <div className="d-flex justify-content-between align-items-center mt-1">
                <p>Wheelbase</p>
                <p className="fw-bold">
                  {" "}
                  {trim?.trim?.wheelbase ? trim?.trim?.wheelbase + "mm" : "-"}
                </p>
              </div>
              <div className="d-flex justify-content-between align-items-center mt-1">
                <p>Weight</p>

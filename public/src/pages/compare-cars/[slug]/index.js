...
import MobileCompareCarResult from "@/mobile/pages/compare-cars/[slug]";
    ...
    <Layout pageMeta={{
      ...
      <div className="container my-3">
        ...
        <div className="bg-white d-flex justify-content-center align-items-center my-2 sticky_filter_scroll">
          ...
          {carToCompare.length < 4 ? (
            <div
              ref={buttonEl}
              onClick={() => setVisible(true)}
              className="d-flex flex-column align-items-center text-center white_bg_wrapper me-2 w-10 pointer"
            >
            ...
            <ConfirmPopup
                  ...
                  <div className="d-flex justify-content-center align-items-center">
                    ...
                    {/* <div className="d-flex justify-content-center my-2">
                      <button
                        ...
                        disabled={specificVehicleFilter.v1Slug === null}
              ...
              footer={
                <div className="d-flex justify-content-center py-2" >
                  {/* <Button label="No" icon="pi pi-times" onClick={cancel} /> */}
...
export async function getServerSideProps({ req, res, params }) {
  console?.log(params?.slug, "paramsssss");

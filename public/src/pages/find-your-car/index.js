...
import MobileHomeCarFilteredPage from "@/mobile/pages/find-your-car";
...
export default function HomeCarFilteredPage(props) {
        ...
        <div className="row mt-1 mb-4 ">
          ...
          <div className="col-3 mb-3">
            <div className="sticky_filter_ad_scroll">
              <Ad300x600 dataAdSlot="1011297670" />
            </div>
          </div>

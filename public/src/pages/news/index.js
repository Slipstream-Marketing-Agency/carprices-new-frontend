...
import Ad970x180 from "@/components/ads/Ad970x180";
    ...
    const fetchData = async () => {
      try {
        ...
        const newsResponse = await axios.get(
          `${process.env.NEXT_PUBLIC_API_URL}blog?pageSize=15&currentPage=${page}&type=news${searchedBrand !== null && searchedModel === null ? "&search=" + searchedBrand.label : "" || searchedModel !== null && searchedBrand === null ? "&search=" + searchedModel.label : "" || searchedBrand !== null && searchedModel !== null ? "&search=" + searchedBrand.label + " " + searchedModel.label : ""}`
        );

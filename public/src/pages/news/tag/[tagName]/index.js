...
export default function NewsListing() {
    ...
    const fetchData = async () => {
      try {
        ...
        const newsResponse = await axios.get(
          `${process.env.NEXT_PUBLIC_API_URL}blog/by-tag/${typeof window != 'undefined' ? localStorage.getItem('newstagId') : ""}?pageSize=15&currentPage=${page}&type=news`
        );
  ...
  // }
  // useEffect(() => {
  //   if (options.length > 0 && selectedOptions === null) {

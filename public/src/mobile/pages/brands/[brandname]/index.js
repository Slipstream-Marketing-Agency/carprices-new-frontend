...
export default function MobileSingleBrand(props) {
    ...
    <Layout pageMeta={{
      ...
      <div className="container my-3">
        ...
        <div className='dynamic_price_desc mb-3'>
          <h2 className='fw-bold'>{props?.models?.models[0]?.brand?.name} UAE Cars Price</h2>
        ...
        <div className="sticky_filter_scroll mb-4">
          <div className="white_bg_wrapper pt-4">
            <div className="d-flex justify-content-center align-items-center search_overflow">
              ...
              <div className="w-116 me-1" style={{ marginLeft: "400px" }}>
        ...
        <div className="row mt-2 mb-4">
          <div className="col-12">
            <div className=" px-2">
              ...
              <div>
                <h2 className='fw-bold mb-3'>{toCamelCase(router?.query?.brandname)} Cars Key Highlights</h2>
...
export async function getServerSideProps({ req, res, params }) {
  try {
    // Run all axios requests in parallel using Promise.all
    const [resBrand, resBodyType, resFuelType, resBrands, resMinMax, resMinMaxPower] = await Promise.all([
    ...
    // If you want more specific error handling based on the error type or response status, you can add conditions here.
    console.error("Error fetching data:", error.message);

    return {
      props: {
        error: 'There was an error fetching data. Please try again later.',
      },
    };
  }
}

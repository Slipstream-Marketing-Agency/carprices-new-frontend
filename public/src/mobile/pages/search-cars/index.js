import BootstrapAccordion from "@/components/common/BootstrapAccordion";
...
export default function MobileSearchCars(props) {
        ...
        <div className="container mt-4 ">
          ...
          <div className="row mt-1 mb-4 ">
            ...
            <div className="sticky_filter_scroll mb-4">
              <div className="white_bg_wrapper pt-2">
                <div className="d-flex justify-content-center align-items-center search_overflow">
                  <div className="w-116 me-1" style={{ marginLeft: "560px" }} >

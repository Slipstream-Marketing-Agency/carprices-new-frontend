...
export default function TrimOverview({ trim }) {
  ...
  useEffect(()=>{
    setCurrentImage(trim?.trim?.images[0]?.image)
  },[trim])
  ...
  const [price, setPrice] = useState(trim?.trim?.price);
  ...
  const calculateEMI = () => {
    ...
    document.getElementById("monthly-repayment-result").innerHTML = emi;

    const totalCost = (emi * n).toFixed(2);
    document.getElementById("total-cost-result").innerHTML = totalCost;

    const totalInterestPayment = (totalCost - p).toFixed(2);
    document.getElementById("down-payment-result").innerHTML =
              ...
              <div className="row">
                <div className="col-12">
                  <div className="row">
                    ...
                    <div className="col-10 selected_image position-relative">
                      <div
                      ...
                      <div>
                        <FeaturedImage width={100} height={100}
                          ...
                          alt={currentImage !=="" ? currentImage?.alt: trim?.trim?.name}
                          title={currentImage !=="" ? currentImage?.alt: trim?.trim?.name}
                        />
                      </div>
                ...
                {/* <div className="col-12 mt-3 btn btn-primary p-1 add_to_compare">
                  <a
                    href=""
              ...
              {trim?.trim?.price === null ? (
                ...
                <div className="calculator mt-2">
                  <div className="calculator-body">
                    <div>
                      <div className="form-group model_insure_btn">
                        ...
                        >
                          <label
                            className={
                              years === "1"
                                ? "btn btn-outline-primary p-1"
                                : "btn btn-primary p-1 p-0"
                            }
                          >
                            <input
                              type="radio"
                    ...
                    <div>
                      <div className="form-group">
                        <small htmlFor="interest-rate">Interest Rate (%)</small>
                        <input
                          type="range"
                          id="interest-rate"
                    ...
                    <div>
                      <div className="form-group">
                        <small htmlFor="down-payment">Down Payment (AED)</small>
                        <input
                          type="range"
                          id="down-payment"
                          className="form-control-range"
                        ...
                        <div className="d-flex justify-content-between">
                          <small>20%</small>
                          <small id="down-payment-value">{downPayment}%</small>
                          <small>80%</small>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div className="result_section_wrapper mt-2 d-flex justify-content-between align-items-center">
                        <div className="form-group">
                          <div
                            type="button"
                            className="btn btn-primary p-1 btn-block"
                        ...
                        <div className="row px-3">
                          ...
                          <div className="col-12">
                            <div className="">
                              ...
                              <small className="fw-bold" id="total-cost-result">

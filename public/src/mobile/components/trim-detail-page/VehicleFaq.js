...
export default function VehicleFaq(trim) {
  ...
  const faq = [
    {
      question: `What is the price range of the ${data?.year} ${data?.brand.name} ${data?.model?.name} ${data?.name}?`,
    ...
    },
    {
      ...
      answer: `The ${data?.year} ${data?.brand.name} ${data?.model?.name} ${data?.name} reaches 0 to 100 km/h in ${data?.zeroToHundred} seconds and has a top speed of ${data?.topSpeed} km/h.`,
      id: 2,
      condition: true,
    },
    {
      question: `What is the range of the ${data?.year} ${data?.brand.name} ${data?.model?.name} ${data?.name}?`,
      answer: `The ${data?.year} ${data?.brand.name} ${data?.model?.name} ${data?.name} has a range of ${data?.range}`,
      id: 3,
    ...
    },
    {
      ...
      answer: `The ${data?.year} ${data?.brand.name} ${
        data?.name
      } is equipped with a ${data?.engine.split(" ")[1]} ${
        data?.engine.split(" ")[0]
      } engine and is paired with a ${data?.transmission} transmission.`,
      id: 4,
      condition:
        data?.fuelType === "Hybrid" ||
        data?.fuelType === "Petrol" ||
    ...
    },
    {
      ...
      answer: `Safety components of the ${data?.year} ${data?.brand.name} ${
        ...
        data?.have360ParkingCamera && "rear park assist, "
    ...
    },
    {
      ...
      `,
      answer: `The ${data?.year} ${data?.brand.name} ${data?.model?.name} ${data?.name} has dimensions of ${data?.length} m length, ${data?.width} m width, and ${data?.height} m height.
      `,
      id: 7,
      condition: true,
    },

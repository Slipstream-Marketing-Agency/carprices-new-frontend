        ...
        <div className="car_description mt-3">
          {minPrice !== maxPrice ? (
            <p>
              ...
              <b>
                {" "}
                AED <Price data={minPrice} /> - AED <Price data={maxPrice} />{" "}
              </b>{" "}
          ...
          {availableTrim?.length === 1 ? (
            <p>
              ...
              <b>{availableTrim.map((trim) => `${trim.name}`).join(", ")}</b>.
            </p>
          ) : (
            <p>
          ...
          {model?.mainTrim?.fuelType === "Electric" ? (
            ""
          ) : model?.minfuelConsumption !== model?.maxfuelConsumption ? (
            <p>
              <b>Fuel Efficiency : </b>It has a fuel economy of{" "}
              <b>
                {model?.minfuelConsumption} kmpl - {model?.maxfuelConsumption}{" "}
                kmpl
              </b>{" "}
            ...
            <p>
              <b>Fuel Efficiency : </b>It has a fuel economy of{" "}
              <b>{model?.minfuelConsumption} kmpl</b>.
            </p>
          )}
          ...
          minRange !== "" ? (
            minRange === maxRange ? (
              <p>
                <b>Range : </b>The claimed range is <b>{minRange}</b> on a
                single charge.
              </p>
            ) : (
              <p>
                <b>Range : </b>The claimed range is{" "}
                <b>
                  {minRange} - {maxRange}
                </b>{" "}

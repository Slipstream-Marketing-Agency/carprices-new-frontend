          ...
          <div className="col-4">
            ...
            >
              <div className="card container h-100">
                <div className="row comparisons_wrapper">
                  <div className="col-6 p-0">
                    ...
                    <div className="d-flex flex-column p-2">
                      ...
                      {item?.v1?.year} {item?.v1?.brand?.name} {item?.v1?.name}
                      </small>
                      <small className="card-text text-danger fw-bold">
                        <span className="text-black fw-bold">AED</span>{" "}
                  ...
                  <div className="col-6 text-end p-0">
                    ...
                    <div className="d-flex flex-column p-2">
                      <small className="card-title fw-bold">
                        {item?.v2?.brand?.name} {item?.v2?.name}
                      </small>
                      <small className="card-text text-danger fw-bold">
                        <span className="text-black fw-bold">From</span>{" "}
                ...
                {/* <div className="btn-view-all py-2">
                      <div className="d-flex align-items-center">
                        <span className="me-1">
                          {item?.v1?.brand?.name} {item?.v1?.name}
                        </span>
                        <span>vs</span>
                        <span className="ms-1">
                          {item?.v2?.brand?.name} {item?.v2?.name}

...
export default function FilteredCarCard({
  ...
  return (
    <div className="col-3 single_card_wrap mb-3" key={uniqueIndex}>
      <div className="card h-100">
        ...
        <div className="px-3 py-2">
          ...
          <div className="position-relative">
            <Tooltip target={`.tooltip-button-${uniqueIndex}`} autoHide={false}>
            ...
            <small
              className={`fw-bold btn btn-light box_shadow tooltip-button-${uniqueIndex}`}
              type="button"
              label="Number"
            >
